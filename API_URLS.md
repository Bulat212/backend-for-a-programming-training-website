...
15. **/userstyle/ (GET, POST)** авторизован
   ...
   - **POST**: Добавляет новую запись в таблицу UserStyle.(допустим если человек купил в магазине стиль). Входные данные — JSON с полями style, is_active. Выходные данные — JSON с полями style, is_active если стиль приобрелся и добавился в таблицу, если стиль уже есть "detail": "Этот стиль уже куплен.". добавить сверку с балансом.
